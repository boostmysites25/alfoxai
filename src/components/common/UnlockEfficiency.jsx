          ...
          <div className="relative">
            ...
            <div className="relative bg-accent1/80 backdrop-blur-sm rounded-2xl p-12 shadow-card">
              <div className="flex flex-col md:flex-row items-center justify-between gap-10">
                {/* Left Content */}
                <div className="flex flex-col text-white items-start gap-6 text-left max-w-2xl" data-aos="fade-right">
                  ...
                  <p className="desc text-tertiary">
                    ...
                    cutting-edge digital solutions designed to maximize efficiency 
